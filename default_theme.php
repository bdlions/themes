...
<!--
            ...
            <div class="row form-group">
                ...
                <div class="col-md-offset-1 col-md-2">
                    <div class="panel panel-primary">Hello World</div>
                </div>
                <div class="col-md-2">
                    <div class="panel panel-success">Hello World</div>
                </div>
                <div class="col-md-2">
                    <div class="panel panel-info">Hello World</div>
                </div>
                <div class="col-md-2">
                    <div class="panel panel-warning">Hello World</div>
                </div>
                <div class="col-md-2">
                    <div class="panel panel-danger">Hello World</div>
                </div>
            </div>-->
                ...
                <div class="col-md-12">
                    ...
                    <div class="content">
                        <div class="embed-container">
                            <iframe src="http://www.youtube.com/embed/XGSy3_Czz8k" frameborder="0"></iframe>
                        </div>
                    </div>
                </div>
            </div>-->
