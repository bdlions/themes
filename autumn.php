...
<html lang="en">
    ...
    <body style="background: rgba(0, 0, 0, 0) linear-gradient(90deg, #dad299 10%, #b0dab9 90%) repeat scroll 0 0;">
        <style>
            body{
                color: #446CCF;
            }
            ...
            .navbar-default {
                background-color: #dd5337!important;
