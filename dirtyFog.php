...
<html lang="en">
    <head>
        ...
        <title>Theme: dirtyFog</title>
        <link rel="stylesheet" type="text/css" href="css/dirtyFog/theme.css">
        <link rel="stylesheet" type="text/css" href="css/dirtyFog/font-awesome.css">
