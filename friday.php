...
<html lang="en">
    <head>
        ...
        <title>Theme: Friday</title>
        <link rel="stylesheet" type="text/css" href="css/friday/theme.css">

        <script type="text/javascript" src="js/jquery-1.11.1.min.js"></script>
        <script type="text/javascript" src="js/bootstrap.min.js"></script>
    </head>
    <!--background: rgba(0, 0, 0, 0) linear-gradient(90deg, #CED8ED 10%, #8DEEEF 90%) repeat scroll 0 0; friday-->
    <body style="background: rgba(0, 0, 0, 0) linear-gradient(90deg, #CED8ED 10%, #8DEEEF 90%) repeat scroll 0 0;">
        <style>
