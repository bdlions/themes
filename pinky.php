...
<html lang="en">
    <head>
        ...
        <title>Theme: Pinky</title>
        <link rel="stylesheet" type="text/css" href="css/pinky/theme.css">

        <script type="text/javascript" src="js/jquery-1.11.1.min.js"></script>
        <script type="text/javascript" src="js/bootstrap.min.js"></script>
    </head>
    <!--background: rgba(0, 0, 0, 0) linear-gradient(90deg, #FFD07F 10%, #f7bb97 90%) repeat scroll 0 0; pinky-->
    <body style="background: rgba(0, 0, 0, 0) linear-gradient(90deg, #FFD07F 10%, #f7bb97 90%) repeat scroll 0 0;">
        <style>
