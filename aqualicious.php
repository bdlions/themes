...
<html lang="en">
    ...
    <!--background: rgba(0, 0, 0, 0) linear-gradient(90deg, #dad299 10%, #b0dab9 90%) repeat scroll 0 0; Aqualicious-->
    <body style="background: rgba(0, 0, 0, 0) linear-gradient(90deg, #A0EA9F 10%, #96deda 90%) repeat scroll 0 0;">
        <style>
            body{
                color: #3D2B1F;
            }
